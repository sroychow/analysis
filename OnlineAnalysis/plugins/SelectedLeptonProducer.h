#ifndef __AnalysisSpace_OnlineAnalysis_SelectedLeptonProducer_h
#define __AnalysisSpace_OnlineAnalysis_SelectedLeptonProducer_h

/*
\class SelectedLeptonProducer SelectedLeptonProducer.cc 
...
class SelectedLeptonProducer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
