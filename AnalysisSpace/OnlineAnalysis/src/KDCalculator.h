#ifndef __AnalysisSpace_OnlineAnalysis_KDCalculator_h
#define __AnalysisSpace_OnlineAnalysis_KDCalculator_h
...
class KDCalculator {
  public:
	...
	+par[7]*(exp(-pow(((ZZMass-par[8])/par[9]), 2))*(ZZMass<par[8])
