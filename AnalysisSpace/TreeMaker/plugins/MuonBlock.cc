...
//  TClass::GetClass("std::vector<vhtm::Muon>")->SetCanSplit(true);
...
*/
      ...
      // Hit pattern
        if( hasTkinRef ) {
          ...
          const reco::HitPattern& hitp = tk->hitPattern(); // innerTrack will not provide Muon Hits
